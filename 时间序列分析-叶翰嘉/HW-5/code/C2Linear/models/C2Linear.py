...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.channels = configs.enc_in # DLinear with --individual, use this hyperparameter as the number of channels
        self.individual = configs.individual # DLinear: a linear layer for each variate(channel) individually
