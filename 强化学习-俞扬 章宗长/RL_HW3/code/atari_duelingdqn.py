...
class CnnDuelingDQNAgent:
    ...
    def learning(self, fr):
        ...
        q_next = self.model(s1)
        q_target = r + self.config.gamma * q_next.max(1)[0].view(-1, 1) * (1 - done)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', default='duelingdqn', type=str, help='algo type')
    ...
    agent = CnnDuelingDQNAgent(config)
