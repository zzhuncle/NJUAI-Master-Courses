...
class CnnDQNAgent:
    ...
    def learning(self, fr):
        ...
        q_next = self.model(s1).max(1)[0]
        q_target = r + self.config.gamma * q_next.view(-1, 1) * (1 - done)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--algo', default='dqn', type=str, help='algo type')
